...
//
// The same binary runs in the client pod and in the intruder pod. The client
// never selects its own identity. The service account of the pod alone
...
const (
	...
	// The Service "server" in the namespace "workloads" resolves to the
	// server pod. The client runs in the same namespace.
