...
#
# This is a spike, so the script is lean. It is still safe to run twice: an
# already-healthy agent is left alone.
...
main() {
  ...
  # material, but the spike still delivers it at runtime and commits no copy.
